...
<div id="ssch">
    ...
    <div id="ssch_frm">
        ...
        <div>
            <strong>검색범위</strong>
            <div class="row-4">
            	<label for="ssch_qname" class="col-4 custom-checkbox flex-start">
					<input type="checkbox" name="qname"  value="1"  id="ssch_qname" class="custom-chk" <?php echo $qname_check?'checked="checked"':'';?> />
					<span class="box"></span>
					<span class="text">상품명</span>
				</label>
				<label for="ssch_qexplan" class="col-4 custom-checkbox flex-start">
					<input type="checkbox" name="qexplan"  value="1"  id="ssch_qexplan" class="custom-chk" <?php echo $qexplan_check?'checked="checked"':'';?> />
					<span class="box"></span>
					<span class="text"><span class="sound_only">상품</span>설명</span>
				</label>
				<label for="ssch_qbasic" class="col-4 custom-checkbox flex-start">
					<input type="checkbox" name="qbasic"  value="1" id="ssch_qbasic" class="custom-chk" <?php echo $qbasic_check?'checked="checked"':'';?> />
					<span class="box"></span>
					<span class="text">기본설명</span>
				</label>
				<label for="ssch_qid" class="col-4 custom-checkbox flex-start">
					<input type="checkbox" name="qid"  value="1" id="ssch_qid" class="custom-chk" <?php echo $qid_check?'checked="checked"':'';?> />
					<span class="box"></span>
					<span class="text">상품</span>코드</span>
				</label>
            </div>
        </div>
        <!--
