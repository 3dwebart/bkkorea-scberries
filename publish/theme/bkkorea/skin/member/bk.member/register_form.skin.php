...
<form id="fregisterform" name="fregisterform" action="<?php echo $register_action_url ?>" onsubmit="return fregisterform_submit(this);" method="post" enctype="multipart/form-data" autocomplete="off" class="pb-4">
	...
	<div class="tbl_frm01 tbl_wrap">
		...
		<ul>
			...
			<li>
				...
				<label for="del_mb_icon" class="custom-checkbox">
					<span class="text">
			...
			<li class="reg_mb_img_file">
				...
				<label for="del_mb_img" class="custom-checkbox">
					<span class="text">
			...
			<li>
				<label for="reg_mb_mailling" class="custom-checkbox">
					<span class="text">메일링서비스</span>
					<input type="checkbox" name="mb_mailling" value="1" id="reg_mb_mailling" <?php echo ($w=='' || $member['mb_mailling'])?'checked':''; ?>>
					<span class="box"></span>
					<span class="text">정보 메일을 받겠습니다.</span>
				</label>
			</li>

			<?php if ($config['cf_use_hp']) {  ?>
			<li>
				<label for="reg_mb_sms" class="custom-checkbox">
					<span class="text">SMS 수신여부</span>
					<input type="checkbox" name="mb_sms" value="1" id="reg_mb_sms" <?php echo ($w=='' || $member['mb_sms'])?'checked':''; ?>>
					<span class="box"></span>
					<span class="text">휴대폰 문자메세지를 받겠습니다.</span>
				</label>
			</li>
			<?php }  ?>
			...
			<li>
				...
				<label for="reg_mb_open" class="custom-checkbox">
					<span class="text">정보공개</span>
					<input type="checkbox" name="mb_open" value="1" <?php echo ($w=='' || $member['mb_open'])?'checked':''; ?> id="reg_mb_open">
					<span class="box"></span>
					<span class="text">다른분들이 나의 정보를 볼 수 있도록 합니다.</span>
				</label>
				<span class="frm_info">
