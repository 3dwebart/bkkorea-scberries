...
<section class="couponzone_list">
	<h2>다운로드 쿠폰</h2>
	<p class="gray">
		<strong class="black"><?php echo $default['de_admin_company_name']; ?> 회원</strong>
		이시라면 <strong class="black">쿠폰 다운로드 후</strong> 바로 사용하실 수 있습니다.
	</p>
...
<section class="couponzone_list" id="point_coupon">
	...
	<p class="gray">
		보유하신 
		<strong class="black"><?php echo $default['de_admin_company_name']; ?> 회원 포인트</strong>를 <strong class="black">쿠폰으로 교환</strong>하실 수 있습니다.
	</p>
