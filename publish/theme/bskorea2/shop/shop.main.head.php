	...
	***** -->
	...
	<script id="hdMenu" type="text/x-jquery-tmpl">
		<div class="container">
			<ul>
				<li>
					<a href="#" class="open-cate-nav"><i class="fa fa-bars"></i> 전체 카테고리</a>
				</li>
				<li>
					<a href="<?php echo G5_SHOP_URL; ?>/listtype.php?type=3">${newest}${item}</a><!-- 신상품 -->
				</li>
				<li>
					<a href="<?php echo G5_SHOP_URL; ?>/listtype.php?type=4">${hot}${item}</a><!-- 인기상품 -->
				</li>
				<li>
					<a href="<?php echo G5_SHOP_URL; ?>/listtype.php?type=5">${sale}${item}</a><!-- 할인상품 -->
				</li>
				
				<li>
					<a href="<?php echo G5_SHOP_URL; ?>/event_list.php">이벤트</a><!-- 이벤트 -->
				</li>
				<li>
...
-->
<?php include_once(G5_THEME_SHOP_PATH.'/shop.quickmenu.php'); ?>
