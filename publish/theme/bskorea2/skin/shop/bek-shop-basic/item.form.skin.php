		...
		<div class="row">
			...
			<div class="col-4">
				...
				<section id="sit_ov" class="2017_renewal_itemform">
					...
					<div class="input-group" style="margin-top: 35px;"><!-- id="sit_ov_btn" -->
						<div class="btn-group">
							<?php if ($is_orderable) { ?>
							<button type="submit" onclick="document.pressed=this.value;" value="바로구매" class="btn btn-scberries"><i class="fa fa-credit-card" aria-hidden="true"></i> 바로구매</button><!--  id="sit_btn_buy" -->
							<button type="submit" onclick="document.pressed=this.value;" value="장바구니" class="btn btn-outline-scberries"><i class="fa fa-shopping-cart" aria-hidden="true"></i> 장바구니</button><!--  id="sit_btn_cart" -->
							<?php } ?>
							<?php if(!$is_orderable && $it['it_soldout'] && $it['it_stock_sms']) { ?>
							<a href="javascript:popup_stocksms('<?php echo $it['it_id']; ?>');" id="sit_btn_alm" class="btn btn-outline-default ml-0"><i class="fa fa-bell-o" aria-hidden="true"></i> 재입고알림</a>
							<?php } ?>
							<a href="javascript:item_wish(document.fitem, '<?php echo $it['it_id']; ?>');" class="btn btn-outline-scberries"><i class="fa fa-heart-o" aria-hidden="true"></i><span class="sound_only">위시리스트</span></a><!--  id="sit_btn_wish" -->
