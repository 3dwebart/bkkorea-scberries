...
<section id="anc_scatefrm_basic">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            <th scope="row">
                <input type="hidden" name="ca_1_subj" id="ca_1_subj" value="메인 메뉴 이미지" class="frm_input">
                <label for="ca_1">메인 메뉴 이미지</label>
            </th>
            <td>
                <input type="file" name="ca_1" id="ca_1" class="">
                <?php if (!empty($ca['ca_1']) && $w == 'u') { ?>
                    <input type="checkbox" name="menu_img_del">
                    <label for="menu_img_del">delete image</label>
                    <img src="<?php echo G5_DATA_URL.'/'.$ca['ca_1']; ?>" alt="<?php echo $ca['ca_name']; ?>" class="img-fluid img-thumbnail" style="width: 80px;">
                <?php } ?>
            </td>
        </tr>
        <tr>
