	...
	<div class="sod_right">
		...
		<section id="sod_frm_pay">
			...
			<div id="od_pay_sl">
				...
				echo '<input type="radio" id="od_settle_paypal" name="od_settle_case" value="페이팔" '.$checked.'> <label for="od_settle_paypal" class="PAYPAL lb_icon">페이팔</label>'.PHP_EOL; //페이팔 라디오박스 추가
				$checked = ''; //checked 풀죠.
