        ...
        <section id="sod_frm_pay">
            ...
            <div id="od_pay_sl">
                ...
                if ($default['de_paypal_use']) {
                    $multi_settle++;
                    echo '<input type="radio" id="od_settle_paypal" name="od_settle_case" value="paypal" '.$checked.'> <label for="od_settle_paypal" class="PAYPAL lb_icon">paypal</label>'.PHP_EOL;
                    $checked = '';
                }
...
function forderform_check(f)
{
    ...
    if (settle_method == "paypal") {
        ...
        window.open("","paypal_payment_window","width=970, height=600, status=yes, scrollbars=yes,resizable=yes, menubar=no");
