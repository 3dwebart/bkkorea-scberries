...
function item_icon($it)
{
    ...
    if ($it['it_type1']) {
        $icon .= '<span class="shop_icon shop_icon_1">'; // hit
        $icon .= '<img src="'.G5_IMG_URL.'/common/icon/icon_hit.png" alt="HIT" />';
        $icon .= '</span>';
    }
    ...
    if ($it['it_type3']) {
        $icon .= '<span class="shop_icon shop_icon_1">'; // hit
        $icon .= '<img src="'.G5_IMG_URL.'/common/icon/icon_new.png" alt="New" />';
        $icon .= '</span>';
    }
    ...
    if ($it['it_type5']) {
        $icon .= '<span class="shop_icon shop_icon_1">'; // hit
        $icon .= '<img src="'.G5_IMG_URL.'/common/icon/icon_sale.png" alt="Sale" />';
        $icon .= '</span>';
    }
